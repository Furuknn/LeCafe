...
public class WaveSystem : MonoBehaviour
{
    ...
    public GameObject pizzaCustomerPrefab;
    ...
    private float spawnRatePizzaCustomer = 0.1f;
    ...
    [HideInInspector] public int customersSpawned = 0;
    ...
    IEnumerator SpawnCustomerWaves()
    {
        ...
        while (customersSpawned < waveSize)
        {
            ...
            {
                customerPrefab = pizzaCustomerPrefab;
            }
        ...
        if (day<=5)
        {
            ...
            spawnRatePizzaCustomer *= 1.5f; // Increase lasagna customer spawn rate by 50%
            Debug.Log(spawnRateCoffeeCustomer + "    " + spawnRateDessertCustomer + "    " + spawnRatePizzaCustomer);
        }
        ...
        spawnRatePizzaCustomer = Mathf.Clamp(spawnRatePizzaCustomer, 0f, 1f);
    }
}